...
export interface KoyeCertificateInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface KoyeCertificate extends BaseContract {
  connect(runner?: ContractRunner | null): KoyeCertificate;
  waitForDeployment(): Promise<this>;

  interface: KoyeCertificateInterface;
  ...
  mintCertificate: TypedContractMethod<
    [to: AddressLike, metadataHash: BytesLike, contentType: BigNumberish],
    [bigint],
    "nonpayable"
  >;
  ...
  filters: {
    ...
    "CertificateMinted(uint256,address,bytes32,uint8,string)": TypedContractEvent<
      CertificateMintedEvent.InputTuple,
      CertificateMintedEvent.OutputTuple,
      CertificateMintedEvent.OutputObject
    >;
